...
MIDDLEWARE = [
    ...
    # Flaw 5: Clickjacking fix - enable this middleware
    #'django.middleware.clickjacking.XFrameOptionsMiddleware',

]

# Flaw 5: Clickjacking fix - enable this setting
...
# Flaw 6: Security Misconfiguration fix
#DEBUG = False
...
# Use BigAutoField as default primary key type (prevents warnings)
